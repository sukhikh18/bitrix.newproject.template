...
$buyButtonClassName = in_array('BUY', $arParams['ADD_TO_BASKET_ACTION_PRIMARY']) ? 'btn-primary' : 'btn-secondary';
$showAddBtn = in_array('ADD', $arParams['ADD_TO_BASKET_ACTION']);
$showButtonClassName = in_array('ADD', $arParams['ADD_TO_BASKET_ACTION_PRIMARY']) ? 'btn-primary' : 'btn-secondary';
...
<div class="bx-catalog-element bx-<?=$arParams['TEMPLATE_THEME']?>" id="<?=$itemIds['ID']?>"
	...
	<?= ($arParams['DISPLAY_NAME'] !== 'Y') ?: '<h1 class="bx-title bx-catalog-element-name">' . $name . '</h1>';  ?>

	<div class="row">
		<div class="col-md-6 col-sm-12 product-item-detail-first-column">
		...
		<div class="col-md-6 col-sm-12 product-item-detail-second-column">
			<div class="product-item-detail-info-section">
				<?php
				/**
				 * unset($arParams['PRODUCT_INFO_BLOCK_ORDER']['sku']);
				 *
				 * include __DIR__ . "/parts/sku.php";
				 * include __DIR__ . "/parts/props.php";
				 */
				foreach ($arParams['PRODUCT_INFO_BLOCK_ORDER'] as $blockName) {
					include __DIR__ . "/parts/$blockName.php";
				}
				?>
			</div>
			<div class="product-item-detail-pay-block">
				<?php
				/**
				 * unset($arParams['PRODUCT_PAY_BLOCK_ORDER']['rating']);
				 *
				 * include __DIR__ . "/parts/rating.php";
				 * include __DIR__ . "/parts/price.php";
				 * include __DIR__ . "/parts/priceRanges.php";
				 * include __DIR__ . "/parts/quantity.php";
				 * include __DIR__ . "/parts/quantityLimit.php";
				 * include __DIR__ . "/parts/buttons.php";
				 */
				foreach ($arParams['PRODUCT_PAY_BLOCK_ORDER'] as $blockName)
				{
					include __DIR__ . "/parts/pay/$blockName.php";
				}
