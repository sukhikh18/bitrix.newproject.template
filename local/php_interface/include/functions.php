        ...
        if ($responsive) {
            switch (strval($columns)) {
                ...
                case '2':
                    ...
                    break;
                case '3':
                    $cl = 'col-12 col-md-6 col-lg-4';
                    break;

                case '5':
                    $cl = 'col-6 col-sm-6 col-md-2-4';
                    break;
                case '6':
                    $cl = 'col-6 col-md-4 col-lg-3 col-xl-2';
                    break;
                case '12':
                    $cl = 'col-1';
                    break; // !@#??
                ...
                case '3-9':
                    $cl = 'col-12 col-sm-4 col-md-3';
                    break;
                case '9-3':
                    $cl = 'col-12 col-sm-8 col-md-9';
                    break;
                ...
                case '4':
                default:
                    $cl = 'col-6 col-sm-6 col-md-4 col-lg-3';
                    break;
            }
