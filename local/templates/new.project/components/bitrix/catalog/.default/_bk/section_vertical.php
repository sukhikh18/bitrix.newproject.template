...
if( !function_exists('viewSmartFilter') ) {
	function viewSmartFilter() {
...
if( !function_exists('viewSidebar') ) {
	function viewSidebar( $path ) {
		$APPLICATION->IncludeComponent(
			"bitrix:main.include",
			"",
			Array(
...
$mainClass = 'col-12';
$sidebarClass = 'col-md-3 col-sm-4 col-sm-push-8 col-md-push-9';
if( isset($arParams['FILTER_HIDE_ON_MOBILE']) && $arParams['FILTER_HIDE_ON_MOBILE'] === 'Y' )
	$sidebarClass .= ' hidden';

if ( $isFilter || $isSidebar ) {
	printf('<div class="%s">', $sidebarClass);

	if ($isFilter) viewSmartFilter();
	if ($isSidebar) viewSidebar( $arParams["SIDEBAR_PATH"] );

	printf('</div>');

	$mainClass = "col-md-9 col-sm-8 col-sm-pull-4 col-md-pull-3";
}
?>
<div id="catalog-main-column" class="<?=$mainClass;?>">
	<div class="row">
		<div class="col-12 component-gift-section">
			<?
		...
		<div class="col-12 section-content">
			...
			<div class="component-compare-list">
			<?php
		...
		if (ModuleManager::isModuleInstalled("sale"))
		{
			echo "<div class='col-12 recom-data-section'><div class='row'>";
