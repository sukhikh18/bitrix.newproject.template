...
if( !function_exists('top_elements') ) {
    function top_elements($arParams, $component) {
        global $APPLICATION;
        ?>
        <!-- Популярные товары -->
        <div class="shop__component_top">
        <?
...
if( !is_shop() ) { ?>
    <div class="shop__component_products-gift-section">
    ...
    <div class="shop__component_section-list">
    <?$APPLICATION->IncludeComponent(
...
<!-- Список сравнения -->
<div class="shop__component_compare-list">
<?
...
<?
    if( is_shop() )
        top_elements($arParams, $component);
?>

<!-- Список товаров -->
<div class="shop__component_section">
<?
